        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
              <p>
                I'm a dedicated Information Technology graduate with a passion
                for creating innovative web solutions. My journey in web
                development started during my college years, where I discovered
                the power of turning ideas into functional, user-friendly
                applications.
              </p>
              <p>
                Throughout my academic and professional journey, I've focused on
              ...
              <p>
                ...
                fellow developers. I'm always eager to take on new challenges
                and learn from every project I work on.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="border-l-4 border-gray-400 dark:border-gray-600 pl-6 py-4 bg-gray-100 dark:bg-gray-800 rounded-r-lg">
              ...
              <p className="text-gray-700 dark:text-gray-300 mt-2">
                ...
                software engineering. Maintained high academic standards while
                actively focusing on programming and
                building structured and maintainable web apps.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="border-l-4 border-gray-400 dark:border-gray-600 pl-6 pr-4 sm:pr-0 py-4 bg-gray-100 dark:bg-gray-800 rounded-r-lg">
              <h3 className="text-xl font-semibold text-black dark:text-white">
              ...
              <div className="text-gray-700 dark:text-gray-300 mt-2 space-y-2">
                <p>
                  Developed and implemented a comprehensive queueing system to
                  improve customer service efficiency.
                </p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    Designed user-friendly interfaces for both customers and
                    staff
                  </li>
                  <li>
                    Implemented real-time queue monitoring and management
                    features
                  </li>
          ...
          <div>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                My goal is to continue growing as a full-stack developer while
                contributing to meaningful projects that make a positive impact.
                I'm passionate about learning new technologies, mentoring
                aspiring developers, and being part of a collaborative team that
    ...
    <section id="about" className="p-4 dark:text-white">
      ...
      <div className="mt-4">
        ...
        <ul className="list-disc list-inside">
          ...
          <h1 className="ml-[21px]">Cum Laude</h1>
        </ul>

        <h3 className="text-lg font-semibold mt-4">Work Experience</h3>
        <ul className="list-disc list-inside">
          <li>
            Intern – Queueing System Developer for Management Information System
          </li>
        </ul>
      </div>
    </section>
